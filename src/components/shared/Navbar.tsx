                    ...
                    <Dialog open={isOpen} onOpenChange={setIsOpen}>
                      ...
                      <DialogContent className="sm:max-w-[425px]">
                        <DialogHeader>
                          ...
                          <DialogDescription>
                            Make changes href your profile here. Click save when you re done.
                          </DialogDescription>
                        </DialogHeader>
                ...
                <div className="block">
                  <ul className="divide-y divide-gray-300  mt-2">
                    <li className="hover:bg-green-500 hover:text-white py-1 px-2 w-full">
                      <Link className={`flex gap-1`} href='/cushrefmer/all-products' > <Palette className="relative top-1" size={18} /> All Ideas</Link>
                    </li>
                    <li className="hover:bg-green-500 hover:text-white py-1 px-2 w-full">
                      <Link className={`flex gap-1`} href={`/${user?.role}/dashboard`}><LayoutDashboard className="relative top-1" size={18} />  Dashboard</Link>
                    </li>
                    <li className="hover:bg-green-500 hover:text-white py-1 px-2 w-full">
                      <Link className={`flex gap-1`} href='/cushrefmer/about'><Info className="relative top-1" size={18} /> About</Link>
                    </li>
                    <li className="hover:bg-green-500 hover:text-white py-1 px-2 w-full">
                      <Link className={`flex gap-1`} href='/cushrefmer/my-orders'><PencilLine className="relative top-1" size={18} /> Blogs</Link>
                    </li>
                    <li onClick={handleLogout} className="hover:bg-green-500  hover:text-white py-1 px-2 w-full flex cursor-pointer">

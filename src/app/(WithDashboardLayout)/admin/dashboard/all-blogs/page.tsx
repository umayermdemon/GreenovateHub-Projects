            ...
            <Card>
                ...
                <CardContent>
                    <div className="space-y-5 px-2 divide-y divide-amber-500">
                        {
                            data.map((blog: TBlog) => (<div key={blog.id} className="flex items-center justify-between pb-2">
                                <div className="flex w-[40%]  items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-muted-foreground">by
                                            <span className="italic ml-1 text-amber-800">{blog.author.name}</span> | <span className="text-sky-800 italic">
                                ...
                                <div className="flex gap-9 w-[60%] justify-end">
                                    ...
                                    <p className="bg-amber-500 px-1.5 py-1 rounded-full text-white">{blog.category}</p>

                    ...
                    <Card>
                        <CardContent>
                            ...
                            />
                            {
                                ...
                                <>
                                    <Label htmlFor="image" className="font-semibold text-[14px]">Current Images<span className="text-green-500 text-xl relative top-0.5">*</span></Label>
                                    <div className="border border-green-500 p-2 grid grid-cols-4 border-dashed">
                                        {
                                            blogData?.images?.map((image: string) => (
                                                <div key={image} className="relative">
                                                    <Image src={image} alt="image" width={200} height={200} className="rounded-sm" />
                                                    <Button
                            ...
                            <div className="space-y-2">
                                <Label htmlFor="image" className="font-semibold text-[14px]">New Images<span className="text-green-500 text-xl relative top-0.5">*</span></Label>
                            ...
                            <div className="flex justify-end">
                                <Button type="submit" className="mt-4 rounded-none bg-green-500 cursor-pointer">{isSubmitting ? "Updating..." : "Update"}</Button>
                            </div>
                        </CardContent>
                    </Card>
                </form>
